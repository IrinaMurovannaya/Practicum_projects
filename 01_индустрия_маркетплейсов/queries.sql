-- 1. Основной запрос для объединения данных заказов, товаров, пользователей, отзывов и категорий
-- Используется для создания витрины для дашборда «МаркетПро»
...
-- 2. Запрос для пользователей и их заказов (активность покупателей)
